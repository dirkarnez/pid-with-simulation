while (true) {
  // line 1
  const left_wheel_velocity = measure_left_wheel_velocity();
  // line 1
  const right_wheel_velocity = measure_right_wheel_velocity();
  // line 1
  const wheel_velocity_error = left_wheel_velocity - right_wheel_velocity;
  ...
  // line 5
  const current_left_wheel_error = target_left_wheel_velocity - left_wheel_velocity;
  // line 6
